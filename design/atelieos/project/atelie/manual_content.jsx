/* ============================================================
   manual_content.jsx — Manual & ajuda content + primitives
   Exposes window.MANUAL_SECTIONS and window.MANUAL_GROUPS.
   ============================================================ */

/* ---------------- primitives ---------------- */
const MN_CALLOUT_ICON = { tip: 'wand', attn: 'alert', err: 'alertCircle', when: 'clock', note: 'fileText' };

function Cal({ tone = 'note', label, children }) {
  return (
...
Object.assign(window, { MANUAL_SECTIONS, MANUAL_GROUPS });
